...
public class MyBoostersGui extends GuiFrame {
    private static final Config GUI = new Config(new File(AxBoosters.getInstance().getDataFolder(), "guis/my-boosters.yml"),
            AxBoosters.getInstance().getResource("guis/my-boosters.yml"),
    ...
    public MyBoostersGui(Player player, MainGui prevGui) {
        super(GUI, player);
